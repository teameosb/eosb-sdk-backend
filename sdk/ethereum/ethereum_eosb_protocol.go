...
import (
	...
	"github.com/teameosb/eosb-sdk-backend/sdk/types"
	"github.com/teameosb/eosb-sdk-backend/utils"
	"github.com/shopspring/decimal"
)

type EthereumEosbProtocol struct{}

func (*EthereumEosbProtocol) GenerateOrderData(version, expiredAtSeconds, salt int64, asMakerFeeRate, asTakerFeeRate, makerRebateRate decimal.Decimal, isSell, isMarket, isMakerOnly bool) string {
...
func (*EthereumEosbProtocol) GetOrderHash(order *sdk.Order) []byte {
...
func (*EthereumEosbProtocol) GetMatchOrderCallData(takerOrder *sdk.Order, makerOrders []*sdk.Order, baseTokenFilledAmounts []*big.Int) []byte {
...
func (*EthereumEosbProtocol) IsValidOrderSignature(address string, orderID string, signature string) bool {
...
func getDomainSeparator() []byte {
	return crypto.Keccak256(
		...
		crypto.Keccak256([]byte("Eosb Protocol")),
	)
}
