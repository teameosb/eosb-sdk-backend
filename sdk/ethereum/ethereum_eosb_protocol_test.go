...
import (
	...
	"github.com/teameosb/eosb-sdk-backend/sdk/crypto"
	"github.com/teameosb/eosb-sdk-backend/utils"
	"github.com/shopspring/decimal"
	"github.com/stretchr/testify/suite"
)

type eosbTestSuite struct {
	suite.Suite
}

func (suite *eosbTestSuite) SetupSuite() {
}

func (suite *eosbTestSuite) TearDownSuite() {
}

func (suite *eosbTestSuite) TearDownTest() {
}

func (suite *eosbTestSuite) TestDomainHash() {
	suite.Equal(
...
func (suite *eosbTestSuite) TestDomainSeparator() {
	suite.Equal(
...
func (suite *eosbTestSuite) TestGetEIP712MessageHash() {
...
func (suite *eosbTestSuite) TestIsValidSignature() {
...
func (suite *eosbTestSuite) TestIsValidOrderSignature() {
	...
	suite.Equal(true, new(EthereumEosbProtocol).IsValidOrderSignature(taker, orderHash, signature))
}
...
func (suite eosbTestSuite) TestGetOrderData() {
...
func (suite *eosbTestSuite) TestGetHash() {
	taker := "0x3870b6f2c0b723f4855d8ad53ab7599b02d4df84"
...
func (suite *eosbTestSuite) TestGetMatchOrdersDataHex() {
	taker := "0x3870b6f2c0b723f4855d8ad53ab7599b02d4df84"
...
func (suite *eosbTestSuite) TestGetAsTakerFeeRateFromOrderData2() {
	data := "01010102540be3ff006400c8006400000000000df8f400000000000000000000"
...
func (suite *eosbTestSuite) TestA() {
	config := "0x1234"
...
func (suite *eosbTestSuite) TestExpireTs() {
...
func TestEosbTestSuite(t *testing.T) {
	suite.Run(t, new(eosbTestSuite))
}
